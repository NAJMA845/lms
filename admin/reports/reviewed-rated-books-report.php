...
$recentReports = [
    [
        ...
        'rating' => 5, // Use an integer value to represent the rating
    ],
];
?>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        Reviewed and Rated Books Report Overview
                    </div>
                    <div class="card-body">
                                ...
                                <tbody>
                                    <?php foreach ($recentReports as $index => $report): ?>
                                        <tr>
                                            ...
                                            <td><?php echo $report['isbn']; ?></td>
                                            <td><?php echo $report['book_title']; ?></td>
                                            <td><?php echo $report['review']; ?></td>
                                            <td><?php echo str_repeat('⭐', $report['rating']); ?></td> <!-- Display rating using stars -->
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
                            </table>
